    ...
    <section className="mx-auto" style={{
      ...
      <div className="container px-5 py-16 mx-auto">
        <div className="flex flex-col text-center w-full mb-16" data-aos="fade-up" data-aos-duration="3000">
          ...
          <h1 className="title-font xl:text-4xl lg:text-2xl md:text-xl sm:text-xl font-extrabold text-white mt-2">A HUGE VARIETY OF THE FRESHEST
            <br className="hidden lg:inline-block" />FOOD AND VEGETABLES
          </h1>
        </div>
        <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4 gap-6" data-aos="zoom-in" data-aos-duration='1000'>
